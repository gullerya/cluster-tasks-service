 ...
 * - we are creating some CHANNELED tasks (1/5 of total)
 * - we are creating many SIMPLE tasks (4/5 of total)
...
public class HeavyClusterMixedToSimpleTasksTest {
	private static final Logger logger = LoggerFactory.getLogger(HeavyClusterMixedToSimpleTasksTest.class);
