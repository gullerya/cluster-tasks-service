 ...
 * - we are creating some SIMPLE tasks (1/5 of total)
 * - we are creating many CHANNELED tasks (4/5 of total)
...
public class HeavyClusterMixedToChanneledTasksTest {
	private static final Logger logger = LoggerFactory.getLogger(HeavyClusterMixedToChanneledTasksTest.class);
