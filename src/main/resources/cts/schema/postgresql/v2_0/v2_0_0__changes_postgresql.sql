...
BEGIN
    INSERT INTO cluster_task_meta (CTSKM_TASK_TYPE, CTSKM_PROCESSOR_TYPE, CTSKM_UNIQUENESS_KEY, CTSKM_CONCURRENCY_KEY, CTSKM_APPLICATION_KEY, CTSKM_DELAY_BY_MILLIS, CTSKM_BODY_PARTITION, CTSKM_ORDERING_FACTOR, CTSKM_CREATED, CTSKM_STATUS)
    VALUES (task_type, processor_type, uniqueness_key, concurrency_key, application_key, delay_by_millis, body_partition, COALESCE(ordering_factor, (EXTRACT(EPOCH FROM LOCALTIMESTAMP) * 1000)::BIGINT + delay_by_millis), LOCALTIMESTAMP, 0)
